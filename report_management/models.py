...
class Database(BaseModel):
    ...
    organization = models.ForeignKey('users.Organization', on_delete=models.CASCADE, related_name='databases')
...
class Query(BaseModel):
    ...
    node = models.ForeignKey(Node, on_delete=models.CASCADE, related_name='queries')
    database = models.ForeignKey(Database, on_delete=models.CASCADE, related_name='queries')
